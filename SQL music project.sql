...
--2) Which countries have then most invoices
Select * from invoice;
Select count(*) as C, billing_country from invoice group by billing_country order by C desc;

--3)What are tp 3 values of total invoice
Select * from invoice;
Select total from invoice order by total desc limit 3;

/*4) which city as the best customers? we would like to throw a promotional music festival in the 
...
/*6) write query to return the email, first_name,last_name, and genre of all rock music listeners.
Return Your list ordered alphabetically by email starting withn A.*/
